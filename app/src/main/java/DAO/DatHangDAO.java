...
public class DatHangDAO {
    ...
    public void InsertDH(DatHang datHang) {
        ...
        values.put(AccountId, datHang.getIdtaikhoanDatHang());
        values.put(TotalPrice, datHang.getTotalpriceDatHang());
        values.put(Created, datHang.getCreatedDatHang());
        values.put(Updated, datHang.getUpdatedDatHang());
    ...
    public List<DatHang> getData(String sql, String... selectionArgs) {
        ...
        while (!cursor.isAfterLast()) {
            ...
            datHang.setIdtaikhoanDatHang(cursor.getInt(cursor.getColumnIndex(AccountId)));
            datHang.setTotalpriceDatHang(cursor.getFloat(cursor.getColumnIndex(TotalPrice)));
            datHang.setCreatedDatHang(cursor.getString(cursor.getColumnIndex(Created)));
            datHang.setUpdatedDatHang(cursor.getString(cursor.getColumnIndex(Updated)));
