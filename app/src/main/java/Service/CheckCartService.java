...
public class CheckCartService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (datHang == null) {
            ...
            datHang1.setIdtaikhoanDatHang(MainActivity.account_all.getId());
            datHang1.setStatusDatHang(0);
            datHang1.setCreatedDatHang(text);
            datHang1.setUpdatedDatHang(text);
        ...
        if (check == 1) {
            ...
            DatHang NewDH = datHangDAO.getBuyingCart(MainActivity.account_all.getId());
